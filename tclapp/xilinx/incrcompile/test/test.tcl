...
source -notrace [file join $test_dir get_reused.tcl]
source -notrace [file join $test_dir get_non_reused.tcl]
source -notrace [file join $test_dir highlight_reused.tcl]
source -notrace [file join $test_dir highlight_non_reused.tcl]
source -notrace [file join $test_dir analyze_critical_path.tcl]
