...
package require ::tclapp::aldec::common::helpers 1.29

package provide ::tclapp::aldec::common::sim 1.29
  ...
  set useAddsc 0
	...
	foreach file $::tclapp::aldec::common::helpers::properties(designFiles) {
		...
		foreach item [ split $cmd_str " " ] {
			...
			if { $commandLine != "" } {
				if { [ string index $item 0 ] == "-" || [ regexp ".*xilinx_versal.o$" $item ] } {
					append commandLine " \\\n\t"
				} else {
					append commandLine " "
				}
...
proc usf_aldec_write_header { fh filename } {
  ...
  puts $fh "#"
  puts $fh "# Script automatically generated by Aldec Tcl Store app 1.29 for '$mode_type' simulation,"
...
proc aldecHeader { _file _fileName _proces } {
	...
	if { $::tcl_platform(platform) == "unix" } {
		...
		puts $_file "# Description : Script for $_proces design source files, automatically generated by Aldec Tcl Store app 1.29"
		...
		puts $_file "REM Description : Script for $_proces design source files, automatically generated by Aldec Tcl Store app 1.29"
...
proc usf_aldec_write_driver_shell_script { do_filename step } {
  ...
  if {$::tcl_platform(platform) == "unix"} {
	...
	if { [ ::tclapp::aldec::common::helpers::isSystemCEnabled ] } {
		puts $scriptFileHandle "export xv_cxl_lib_path=\"[ ::tclapp::aldec::common::helpers::getCompiledLibraryLocation ]\""   
