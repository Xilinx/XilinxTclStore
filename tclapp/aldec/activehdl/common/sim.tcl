...
package provide ::tclapp::aldec::common::sim 1.35
...
proc usf_aldec_write_header { fh filename } {
  ...
  puts $fh "#"
  puts $fh "# Script automatically generated by Aldec Tcl Store app 1.35 for '$mode_type' simulation,"
...
proc aldecHeader { _file _fileName _proces } {
	...
	if { $::tcl_platform(platform) == "unix" } {
		...
		puts $_file "# Description : Script for $_proces design source files, automatically generated by Aldec Tcl Store app 1.35"
		...
		puts $_file "REM Description : Script for $_proces design source files, automatically generated by Aldec Tcl Store app 1.35"
