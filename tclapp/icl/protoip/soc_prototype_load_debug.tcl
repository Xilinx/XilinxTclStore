...
namespace eval ::tclapp::icl::protoip {
    ...
    namespace export soc_prototype_load_debug
}
...
uplevel [concat ::tclapp::icl::protoip::soc_prototype_load_debug::soc_prototype_load_debug $args]
}

# Trick to silence the linter
eval [list namespace eval ::tclapp::icl::protoip::soc_prototype_load_debug::soc_prototype_load_debug {
...
proc ::tclapp::icl::protoip::soc_prototype_load_debug::soc_prototype_load_debug { args } {
  # Summary :
  # Argument Usage:
  # Return Value:
