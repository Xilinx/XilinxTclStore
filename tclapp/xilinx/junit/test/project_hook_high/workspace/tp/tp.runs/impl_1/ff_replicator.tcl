...
set rc [catch {
  ...
  add_files C:/Users/nikc/Desktop/jenkins/project_hook_high/workspace/tp/tp.runs/synth_1/ff_replicator.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source C:/Users/nikc/Desktop/jenkins/project_hook_high/hook_impl.tcl"
    source C:/Users/nikc/Desktop/jenkins/project_hook_high/hook_impl.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script C:/Users/nikc/Desktop/jenkins/project_hook_high/hook_impl.tcl failed"
    return -code error
  }
