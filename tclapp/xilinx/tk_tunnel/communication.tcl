...
namespace eval ::tclapp::xilinx::tk_tunnel {
	...
	proc launch_server {{tclsh_path "tclsh"} {server_file {}}} {
        ...
        if { $server_file == {} } {
            set server_file [file join [file dirname [info script]] "server" "start.tcl"]
        }
		puts "Attempting to launch server using '$server_file'"
