...
proc ::tclapp::xilinx::utils::getHighFanoutRegs {maxFan inst hiFanRegs hiFanNets hiFanLoads} {
...
proc ::tclapp::xilinx::utils::copyReg {regOrig netOrig copyIndex} {
...
proc ::tclapp::xilinx::utils::replicateRegs {maxFan hiFanNets hiFanLoads} {
    # Summary : 
...
proc ::tclapp::xilinx::utils::limitRegFanout { {maxFan 100} {inst *} {reportOnly 0} } {
