...
proc register_options { simulator } {
  ...
  variable options
  if { {} == $simulator } {
    send_msg_id USF-[::tclapp::aldec::common_helpers::usf_getSimulatorName]-98 ERROR "Simulator not specified.\n"
  }
  # is simulator registered?
  if { {-1} == [lsearch [get_simulators] $simulator] } {
    send_msg_id USF-[::tclapp::aldec::common_helpers::usf_getSimulatorName]-99 ERROR "Simulator '$simulator' is not registered\n"
    return 1
  }
