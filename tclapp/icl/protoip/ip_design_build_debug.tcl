...
if {$error==0} {  
  ...
  Description: Open the project named 'project_name' in the Vivado HLS GUI to debug the IP hardware design.

  Example:
  tclapp::icl::protoip::ip_design_build_debug -project_name my_project0
