...
proc ::tclapp::xilinx::utils::createDiffPortScalar {port} {
...
proc ::tclapp::xilinx::utils::createDiffPort {port {idxMax {}} {idxMin {}} } {
    # Summary: Takes a port and creates its diff pair member
...
proc ::tclapp::xilinx::utils::getPortNames {baseNames busIndexMax busIndexMin} {
...
proc ::tclapp::xilinx::utils::getPairPin {portP} {
...
# Top-level proc
proc ::tclapp::xilinx::utils::makeDiffPorts {} {
