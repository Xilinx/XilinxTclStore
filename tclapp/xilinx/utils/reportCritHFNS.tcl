...
proc ::tclapp::xilinx::utils::reportCritHFNS {{sortBy slack} {limitFO 256}  {limitSlack 0}} {
...
proc ::tclapp::xilinx::utils::lsortSlack {left right} {
...
proc ::tclapp::xilinx::utils::lsortFanout {left right} {
    # Summary : sorting appity proc
