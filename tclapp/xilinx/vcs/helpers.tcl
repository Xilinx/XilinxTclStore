...
proc usf_write_design_netlist {} {
  ...
  switch -regexp -- $a_sim_vars(s_simulation_flow) {
    {post_synth_sim} {
      ...
      send_msg_id Vivado-VCS-999 INFO "write_verilog $wv_args"
      ...
      if { {timing} == $a_sim_vars(s_type) } {
        ...
        send_msg_id Vivado-VCS-999 INFO "write_sdf $ws_args"
...
proc usf_copy_glbl_file {} {
  ...
  if {[catch {file copy -force $src_glbl_file $run_dir} error_msg] } {
    send_msg_id Vivado-VCS-999 WARNING "failed to copy glbl file '$src_glbl_file' to '$run_dir' : $error_msg\n"
  }
}
