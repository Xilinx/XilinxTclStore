...
proc usf_get_compile_order_files { } {
  ...
  # Argument Usage:
  # Return Value:
  return [usf_uniquify_cmd_str $::tclapp::xilinx::xsim::l_compile_order_files]
}
  ...
  if { [llength $data_files] > 0 } {
    ...
    foreach file $data_files {
      ...
      if {[catch {file copy -force $file $export_dir} error_msg] } {
        send_msg_id XSim-Tcl-065 WARNING "Failed to copy file '$file' to '$export_dir' : $error_msg\n"
      } else {
        send_msg_id XSim-Tcl-066 INFO "Exported '$file'\n"
      }
    }
  }
}
