...
package require ::tclapp::aldec::common::helpers 1.19.1

package provide ::tclapp::aldec::common::sim 1.19.1
...
proc usf_aldec_write_header { fh filename } {
  ...
  puts $fh "#"
  puts $fh "# Script automatically generated by Aldec Tcl Store app 1.19.1 for '$mode_type' simulation,"
