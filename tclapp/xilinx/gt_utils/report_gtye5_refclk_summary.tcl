...
namespace eval ::tclapp::xilinx::gt_utils {
  ...
  #namespace export find_connected_pin 
  #namespace export find_connected_core 
  #namespace export get_parent not_empty_int 
  #namespace export evaluate_bd_properties 
  #namespace export map_int get_latest_vlnv 
  #namespace export EvalSubstituting 
...
##
##   Vivado% xilinx::gt_utils::report_gtye5_refclk_summary
##########################################################################################################

namespace eval ::tclapp::xilinx::gt_utils {

proc report_gtye5_refclk_summary {args} {

  # Summary: 
  # Generates reference clock summary of gt_quad base IP based, IPI block design
  # Command to generate the summary is
  #                    xilinx::gt_utils::report_gtye5_refclk_summary
...
set file_name1 "$pathk\/$proj.srcs/sources_1/imports/GTREFCLK_SUMMARY\/$bd_dk\_gtye5_refclk_summary.txt"
   ...
   set quadList ""
    ...
    if { $quad_cell_l eq ""} {
       puts "ERROR: There is no gt_quad_base IP in the design. Script is valid only for gt_quad_base IP based designs"
       ...
       if { [file exists $file_name1] == 1} {
        ...
        puts $outfilek " "
        puts $outfilek "                                              xilinx::gt_utils::report_gtye5_refclk_summary"
...
proc find_connected_pin { connected_to } {
  # Summary: 
...
proc find_connected_core { connected_to } {
  # Summary: 
...
proc evaluate_bd_properties { tx0Handle tx1Handle tx2Handle tx3Handle rx0Handle rx1Handle rx2Handle rx3Handle } {
  # Summary: 
...
proc map_int {lambda larg {cull_empty 0}} {
  # Summary: 
  # Maps latest vlnv 
