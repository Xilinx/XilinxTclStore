...
## Examples:
## ---------
## <vivado_install_dir>/data/XilinxTclStore/tclapp/mentor/questa_autocheck/setup_qautocheck_vivado_button.csh
## <questa_autocheck_install_dir>/share/fpga_libs/Xilinx/setup_qautocheck_vivado_button.csh
## 
## Script created on 08/09/2017 by Islam Ahmed (Mentor Graphics Inc) 

set remove = 0
set usage = "Usage : setup_qautocheck_vivado_button.csh [-remove]"
if ( $#argv > 1 ) then
...
set setup_file = "QUESTA_AUTOCHECK_VIVADO_SETUP_FILE.tcl"
rm -f $setup_file
...
if ( $remove == 0 ) then
  ...
  echo "write_questa_autocheck_script -remove_button"  >> $setup_file
endif
