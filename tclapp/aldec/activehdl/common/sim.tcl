...
package require ::tclapp::aldec::common::helpers 1.20

package provide ::tclapp::aldec::common::sim 1.20
...
proc usf_aldec_create_do_file_for_compilation { do_file } {
  ...
  if { [get_param "project.writeNativeScriptForUnifiedSimulation"] && $::tcl_platform(platform) == "unix" } {
    # no op
  } else {
...
proc usf_aldec_write_header { fh filename } {
  ...
  puts $fh "#"
  puts $fh "# Script automatically generated by Aldec Tcl Store app 1.20 for '$mode_type' simulation,"
