...
proc ::tclapp::mentor::questa_autocheck::write_questa_autocheck_script {args} {
  ...
  if { [catch {open $userOD/$run_makefile w} result] } {
    ...
    puts "INFO: Writing Questa AutoCheck run Makefile to file $run_makefile"
  }
  ...
  if { [catch {open $userOD/$qautocheck_ctrl w} result] } {
    ...
    puts "INFO: Writing Questa AutoCheck control directives script to file $qautocheck_ctrl"
  }
  ...
  if { [catch {open $userOD/$qautocheck_compile_tcl w} result] } {
    ...
    puts "INFO: Writing Questa AutoCheck Tcl script to file $qautocheck_compile_tcl"
  }
...
#  puts "}\n"
  ...
  puts $qautocheck_compile_tcl_fh "#"
  puts $qautocheck_compile_tcl_fh "vlog $verilog_define_options -work xil_defaultlib $vivado_dir/data/verilog/src/glbl.v"
  ...
  puts "INFO : Generation of running scripts for Questa AutoCheck is done."
