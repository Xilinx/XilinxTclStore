...
namespace eval ::tclapp::xilinx::projutils {
    ...
    proc write_sim_script {} {
        ...
        send_msg_id Vivado-projutils-021 INFO \
          "File '$a_global_sim_vars(s_driver_script)' exported (file path:$a_global_sim_vars(s_sim_files_dir)/$a_global_sim_vars(s_driver_script))\n"
    ...
    proc export_simulation_for_object { obj_name } {
        ...
        send_msg_id Vivado-projutils-024 INFO \
          "Generating files for '$a_global_sim_vars(s_simulator_name)' simulator (Design Tcl Object is '$obj_name')...\n"
