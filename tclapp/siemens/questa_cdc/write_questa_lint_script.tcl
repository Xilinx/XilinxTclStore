...
proc ::tclapp::siemens::questa_cdc::write_questa_lint_script {args} {
  ...
  if { $add_button == 1 } {
    ...
    ## -----------------------------------------
    ## 0=Run%20Questa%20Lint tclapp::siemens::questa_cdc::write_questa_lint_script "" /home/iahmed/questa_lint_logo.PNG "" "" true ^@ "" true 4 Top%20Module "" "" false Output%20Directory "" -output_directory%20OD1 true Use%20Existing%20XDC "" -use_existing_xdc true Invoke%20Questa%20Lint%20Run "" -run true
    ## -----------------------------------------
    ...
    puts $commands_fh "    <command>source \$::env(QHOME)/share/fpga_libs/Xilinx/write_questa_lint_script.tcl; tclapp::siemens::questa_cdc::write_questa_lint_script</command>"
...
# 
#			 set button_code "$button_code source%20\$::env(QHOME)/share/fpga_libs/Xilinx/write_questa_lint_script.tcl;%20tclapp::siemens::questa_cdc::write_questa_lint_script"
