...
# Description      :  Simulation flow for "VCS_MX" Simulator  
#
# Revision History :
...
proc compile { args } {
  ...
  ::tclapp::xilinx::simutils::usf_launch_script "vcs_mx" $step
}
...
proc usf_vcs_mx_setup_simulation { args } {
  ...
  ::tclapp::xilinx::simutils::usf_set_simulator_path "vcs_mx"
  ...
  for {set i 0} {$i < [llength $args]} {incr i} {
    ...
    switch -regexp -- $option {
      ...
      default {
        ...
        if { [regexp {^-} $option] } {
          send_msg_id Vivado-simutils-999 ERROR "Unknown option '$option', please type 'simulate -help' for usage info.\n"
          return 1
        }
      }
    }
...
proc usf_vcs_mx_write_setup_files {} {
  ...
  puts $fh "OTHERS=$::tclapp::xilinx::vcs_mx::a_vcs_mx_sim_vars(s_compiled_lib_dir)/$filename"
  set libs [list]
...
proc usf_vcs_mx_write_compile_script {} {
  ...
  set files [::tclapp::xilinx::simutils::usf_uniquify_cmd_str [::tclapp::xilinx::simutils::usf_get_files_for_compilation "vcs_mx"]]
  foreach file $files {
  ...
  if { [::tclapp::xilinx::simutils::usf_compile_glbl_file "vcs_mx" $b_load_glbl] } {
    set work_lib_sw {}
    if { {work} != $default_lib } {
      set work_lib_sw "-work $default_lib "
    }
    set file_str "${work_lib_sw}\"[::tclapp::xilinx::simutils::usf_get_glbl_file]\""
...
proc usf_vcs_mx_write_simulate_script {} {
  ...
  ::tclapp::xilinx::simutils::usf_create_do_file "vcs_mx" $do_filename
  set tool "${top}_simv"
  set top_lib [::tclapp::xilinx::simutils::usf_get_top_library]
